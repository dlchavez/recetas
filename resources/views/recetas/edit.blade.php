...
@endsection
@section('content')
<h1 class="text-center mb-5">Editar Receta: {{$receta->nombre}}</h1>
    ...
    <div class="col-md-8">
        <form method="POST" action="{{route('recetas.update',['receta'=>$receta->id])}}" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group mt-3">
                ...
                <input name="ingredientes" type="hidden" id="ingredientes"
            ...
            <div class="form-group mt-3">
                ...
                <input name="preparacion" type="hidden" id="preparacion"
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" vvalue="Editar Receta">
            </div>
        </form>
    </div>
</div>
